...
def main():
    ...
    final_ship_mass = ship[-1, -1] # ship mass at end of ion transfer
    ...
    if arrival_time is not None:
        ...
        ionDeltaV = exhaust_v * math.log(wet_mass/final_mass)
        ...
        print("Ion Propellant Expended (t): "+str((wet_mass - final_mass)*1e-3))
